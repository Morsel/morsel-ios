...
#import "MRSLDraftsViewController.h"
...
@interface MRSLDraftsViewController ()
...
@implementation MRSLDraftsViewController
...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView
    ...
    if (!morsel.isUploadingValue && !morsel.didFailUploadValue) {
        MRSLPostMorselCollectionViewCell *postMorselCell = [collectionView dequeueReusableCellWithReuseIdentifier:@"ruid_PostMorselCell"
                                                                                                 forIndexPath:indexPath];
        postMorselCell.morsel = morsel;
        feedCell = postMorselCell;
    } else if (morsel.isUploadingValue && !morsel.didFailUploadValue) {
        MRSLUploadCollectionViewCell *uploadCell = [collectionView dequeueReusableCellWithReuseIdentifier:@"ruid_UploadProgressCell"
                                                                                               forIndexPath:indexPath];
        uploadCell.morsel = morsel;

        feedCell = uploadCell;
    } else if (!morsel.isUploadingValue && morsel.didFailUploadValue) {
        MRSLUploadFailureCollectionViewCell *uploadCell = [collectionView dequeueReusableCellWithReuseIdentifier:@"ruid_UploadFailCell"
                                                                                                      forIndexPath:indexPath];
        uploadCell.morsel = morsel;
