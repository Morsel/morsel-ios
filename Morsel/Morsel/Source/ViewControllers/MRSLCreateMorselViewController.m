...
@interface MRSLCreateMorselViewController ()
...
@property (weak, nonatomic) IBOutlet MRSLCreateMorselButtonPanelView *createMorselButtonPanelView;

@property (nonatomic, strong) NSString *temporaryPostTitle;

@property (nonatomic, strong) MRSLAddTextViewController *addTextViewController;
@property (nonatomic, strong) MRSLUserPostsViewController *userPostsViewController;
...
@implementation MRSLCreateMorselViewController
...
- (void)addMediaDataToCurrentMorsel {
    ...
    BOOL imageIsLandscape = [MRSLUtil imageIsLandscape:_capturedImage];
    CGFloat cameraDimensionScale = [MRSLUtil cameraDimensionScaleFromImage:_capturedImage];
