...
@interface MRSLDetailPanelViewController ()
...
@property (nonatomic, strong) MRSLDetailCommentsViewController *morselDetailCommentsVC;

@end

@implementation MRSLDetailPanelViewController
